...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { d_item: @producto.d_item, direccion_ven: @producto.direccion_ven, nombre: @producto.nombre, precio_item: @producto.precio_item, total_items: @producto.total_items, vendedor: @producto.vendedor } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { d_item: @producto.d_item, direccion_ven: @producto.direccion_ven, nombre: @producto.nombre, precio_item: @producto.precio_item, total_items: @producto.total_items, vendedor: @producto.vendedor } }
